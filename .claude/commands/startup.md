...
### Post Startup Status
🚀 [Echo-CC-DINE-Navajo-{timestamp}] SYSTEM_ONLINE
...
🔧 [Echo-CC-DINE-Navajo] TOOL_USE: {tool_name}
├─ PURPOSE: {why using this tool}
├─ PARAMS: {key parameters}
└─ STATUS: Executing...

### EVERY File Operation:
📁 [Echo-CC-DINE-Navajo] FILE_OP: {operation_type}
...
🤔 [Echo-CC-DINE-Navajo] DECISION: {decision_type}
...
🚀 [Echo-CC-DINE-Navajo] TASK_START: {task_name}
...
⚡ [Echo-CC-DINE-Navajo] STEP_{N}: {step_description}
├─ TOOL: {MCP being used}
...
📊 [Echo-CC-DINE-Navajo] PROGRESS: {task_name}
├─ COMPLETE: {X}%
...
💻 [Echo-CC-DINE-Navajo] CODE_WORK: {project_name}
...
🔍 [Echo-CC-DINE-Navajo] RESEARCH: {topic}
...
🧠 [Echo-CC-DINE-Navajo] MEMORY_OP: {operation}
...
### Task Completion:
✅ [Echo-CC-DINE-Navajo] TASK_COMPLETE: {task_name}
