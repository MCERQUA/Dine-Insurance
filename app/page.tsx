            ...
            <div key={index} className="w-full flex-shrink-0 px-4">
              <div className="text-center">
                ...
                <div>
                  ...
                  <div className="text-red-clay-700 font-medium">{testimonial.tribe}</div>
                </div>
              </div>
            </div>
          ))}
        ...
        {testimonials.map((_, index) => (
          <button
            ...
            className={cn(
              ...
              index === currentIndex ? "bg-red-clay-600" : "bg-gray-300"
            )}
          />
        ))}
      </div>
    ...
    <div className="min-h-screen gradient-bg">
      ...
      <section className="relative py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-gradient-to-r from-sand-100/50 to-turquoise-100/50" />
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-red-clay-200/30 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-turquoise-200/30 rounded-full blur-3xl" />
        </div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex justify-center mb-6">
              <Mountain className="w-16 h-16 text-red-clay-600" />
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 font-serif">
              From the Sacred Winds of History
              <span className="block text-red-clay-600">To the Four Sacred Directions of Your Future</span>
            </h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-white to-sand-50">
              <CardHeader>
                <div className="w-12 h-12 bg-red-clay-100 rounded-lg flex items-center justify-center mb-4">
                  <Mountain className="w-6 h-6 text-red-clay-600" />
                </div>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-white to-turquoise-50">
              <CardHeader>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-white to-red-clay-50">
              <CardHeader>
                <div className="w-12 h-12 bg-red-clay-100 rounded-lg flex items-center justify-center mb-4">
                  <Shield className="w-6 h-6 text-red-clay-600" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-white to-sand-50">
                <CardHeader>
                  <div className="w-12 h-12 bg-red-clay-100 rounded-lg flex items-center justify-center mb-4">
                    <service.icon className="w-6 h-6 text-red-clay-600" />
                  </div>
                ...
                <CardContent>
                  ...
                  <Link href="/services">
                    <Button variant="ghost" className="mt-4 text-red-clay-600 hover:text-red-clay-700 p-0">
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact">
              <Button size="lg" className="bg-white text-red-clay-600 hover:bg-sand-50 px-8 py-3">
                Get Your Quote
              </Button>
            </Link>
            <Link href="/contact">
